...
const Profile = () => {
  ...
  const resetAllData = () => {
    // Clear ALL localStorage data - comprehensive reset
    localStorage.clear();
    ...
    toast({
      ...
      description:
        "All workout data, progress tracking, and settings have been cleared.",
    });

    setShowResetDialog(false);

    // Use a more aggressive page reload to clear all state
    setTimeout(() => {
