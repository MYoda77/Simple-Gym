...
const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sm:glass sm:border-b sm:border-border/50 sm:backdrop-blur-xl sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 py-4 sm:py-4 py-2">
        <div className="flex justify-between items-center gap-4">
          ...
          {/* Mobile Menu Button - No frame on mobile, framed on tablet+ */}
          <button
            onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
            className="lg:hidden bg-transparent border-0 p-0 sm:p-2 sm:bg-background/50 sm:hover:bg-background sm:border sm:border-border sm:rounded-md text-foreground hover:text-primary transition-colors"
