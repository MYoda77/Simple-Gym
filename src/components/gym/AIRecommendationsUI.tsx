            ...
            <div className="p-3 bg-background/50 rounded-lg space-y-2">
              ...
              {typeof recommendation.action.details === "string" ? (
                ...
                <div className="text-sm text-muted-foreground space-y-1">
                  {Object.entries(recommendation.action.details).map(
                    ([key, value]) => (
                      <div key={key}>
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="glass border-border/50">
        ...
        <CardContent>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-muted-foreground">
                {recommendations.length} personalized recommendations based on
                your training
              </p>
      ...
      <div className="flex gap-2 flex-wrap">
        ...
        {(
          ["next-workout", "muscle-balance", "recovery", "progression"] as const
        ).map((type) => {
