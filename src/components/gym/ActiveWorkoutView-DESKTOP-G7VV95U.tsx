...
const ActiveWorkoutView: React.FC<ActiveWorkoutViewProps> = ({
  ...
  return (
    <div className="max-w-md mx-auto p-2 sm:p-4 space-y-3 sm:space-y-4">
      {/* Header */}
      <div className="flex justify-between items-center">
        <h1 className="text-lg sm:text-xl font-bold">{activeWorkout}</h1>
        <Button onClick={onEndWorkout} variant="ghost" size="icon">
          <X className="w-5 h-5" />
        </Button>
      </div>
      ...
      {hasFormTips(currentExercise.name) &&
      getFormTips(currentExercise.name) ? (
        <Card className="bg-black border-border/30 overflow-hidden">
          <CardContent className="p-2 sm:p-4">
            <div className="relative">
              <img
                src={getFormTips(currentExercise.name)!.gifUrl}
              ...
              <Button
                ...
                onClick={() => {
                  setSelectedFormTips(getFormTips(currentExercise.name));
        ...
        <Card className="hidden sm:block bg-muted/20 border-border/30">
          <CardContent className="p-8 text-center">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-1">
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      setCurrentWeight(Math.max(0, currentWeight - 1))
                    }
                  >
