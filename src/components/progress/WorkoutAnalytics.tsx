...
export const WorkoutAnalytics = ({
  ...
  console.log("WorkoutAnalytics received:", {
  ...
  const muscleGroupData = useMemo(() => {
    ...
    const result = Array.from(muscleMap.entries()).map(([name, value]) => ({
      name,
      value,
    }));
    console.log("Muscle group data:", result);
    return result;
  }, [filteredWorkouts]);
  ...
  return (
    <>
      <style>{`
        ...
        .recharts-layer.recharts-bar-background,
        .recharts-rectangle.recharts-bar-background {
        ...
        <CardContent className="space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <div className="h-64 [&_svg_rect[fill*='240']]:opacity-0 [&_svg_rect[fill*='241']]:opacity-0 [&_svg_rect[opacity='0.3']]:hidden [&_svg_rect[opacity='0.5']]:hidden">
            ...
            <div className="space-y-2">
              ...
              <div className="h-64 [&_svg_rect[fill*='240']]:opacity-0 [&_svg_rect[fill*='241']]:opacity-0 [&_svg_rect[opacity='0.3']]:hidden [&_svg_rect[opacity='0.5']]:hidden">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={prProgressionData} barCategoryGap="20%">
                    <XAxis
                      dataKey="exercise"
                      stroke="hsl(var(--muted-foreground))"
                      fontSize={10}
